-- Must run before 0001_initial_schema (patients.id default calls generate_patient_id()).
-- Kept in sync with migrations/20260617_01_fix_generate_patient_id.sql
...
COMMENT ON FUNCTION generate_patient_id() IS
  'Patient IDs: ma####-YY. Sequence per calendar year; collision-safe. See migrations/20260617_01_fix_generate_patient_id.sql.';
